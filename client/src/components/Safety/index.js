    ...
    return(
        ...
        <div id = "testimonialPage">
            ...
            <div id = "Body">
                ...
                <div id = "subHeader2">Safety by Design: Safety in Mind</div>
                ...
                <div id = "safetyRow" className = "row d-flex justify-content-center">
                    ...
                    <div id = "safetyCol" className = "col-sm-4 mx-auto">
                            ...
                            <div id = "imageHeader">Background Checks</div>
                            <div id = "imageText">
                                Save time by effortlessly searching for certified Health and Wellness near you. All of our coaches go through extensive background checks.
                            </div>
                    </div>
                    ...
                    <div id = "safetyCol" className = "col-sm-4 mx-auto">
                            ...
                            <div id= "imagePlaceHolder">Image</div>
                            <div id = "imageHeader">Secure Payments</div>
                            <div id = "imageText">
                            Quickly review the coaches profile and book on the spot! Every session through EvolvU can be booked online within minutes and all financial transactions are securely processed.
                            </div>
                    </div>
                    
                    <div id = "safetyCol" className = "col-sm-4 mx-auto">
                            <div id= "imagePlaceHolder">Image</div>
                            <div id = "imageHeader">Account Protection</div>
                            <div id = "imageText">
                ...
                <div id = "safetyRow" className = "row d-flex justify-content-center" style = {{marginTop: "50px", marginBottom: "50px"}}>

                    <div id = "safetyCol" className = "col-sm-4 mx-auto">
                            <div id= "imagePlaceHolder">Image</div>
                            <div id = "imageHeader">Scan Protection</div>
                            <div id = "imageText">
                                Save time by effortlessly searching for certified Health and Wellness near you. All of our coaches go through extensive background checks.
                            </div>
                    </div>
                ...
                <div id = "subHeader">We are Here if You Need Us</div>

                <div style = {{marginTop: "2rem", marginBottom: "4rem"}}> 
                    Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam 
                    erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam 
                    erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata 
                    sanctus est.
